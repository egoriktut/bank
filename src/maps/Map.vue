...
export default {
  mounted() {
    // Здесь вы можете вставить ваши скрипты
    this.loadScripts();
  },
  methods: {
    loadScripts() {
      // Загрузка скриптов
      this.loadScript('https://api-maps.yandex.ru/2.1/?lang=ru_RU&apikey=0edc4d7d-911c-4330-809b-c5d35fd2d76d');
      this.loadScript('https://yandex.st/jquery/2.2.3/jquery.min.js');
